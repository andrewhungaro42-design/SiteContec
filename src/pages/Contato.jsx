        ...
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-14">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-bold text-lg" style={{ color: '#4db870' }}>(32) 98805-1075</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-bold text-lg" style={{ color: '#ec4899' }}>@sonhodeummeninoong</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base" style={{ color: '#6b7280' }}>Juiz de Fora, MG</p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    <img src={pixLogo} alt="PIX" className="h-6 object-contain" />
                    <span
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl text-white font-bold text-base transition-all duration-200"
